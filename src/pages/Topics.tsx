    ...
    <div style={{ background: '#f5f0e8' }} className="min-h-screen">
      ...
      >
        <div className="max-w-7xl mx-auto px-4 md:px-6 text-center">
          ...
          <p style={{ fontFamily: '"Source Serif 4", Georgia, serif', color: '#5a4030' }} className="text-sm md:text-lg max-w-2xl mx-auto mb-6 md:mb-8 px-2">
          ...
          <div className="flex gap-6 md:gap-8 justify-center flex-wrap">
            {[
              ...
              <div key={s.label} className="text-center">
                <div style={{ fontFamily: '"Playfair Display", Georgia, serif', color: '#c0392b' }} className="text-xl md:text-2xl font-bold">
                  {s.value}
                </div>
                <div style={{ fontFamily: '"IBM Plex Mono", monospace', color: '#7a6a55' }} className="text-[9px] md:text-[10px] tracking-widest uppercase">
                  {s.label}
                </div>
              </div>
            ))}
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 py-8 md:py-10">
        ...
        <div className="relative mb-5 md:mb-6">
          <svg className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4" fill="none" stroke="#c0392b" viewBox="0 0 24 24" style={{ opacity: 0.5 }}>
